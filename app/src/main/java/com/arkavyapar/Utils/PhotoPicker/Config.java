...
package com.arkavyapar.Utils.PhotoPicker;
...
public class Config {
    ...
    private int cameraBtnImage = R.drawable.ic_camerabtn_ring;
    private int cameraBtnBackground = R.drawable.ic_remove_doc;

    private int selectedCloseImage = R.drawable.ic_remove_doc;
