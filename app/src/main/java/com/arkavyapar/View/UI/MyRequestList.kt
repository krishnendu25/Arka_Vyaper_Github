...
class MyRequestList : AppCompatActivity() {
    ...
    var requests_list: RecyclerView? = null
    ...
    private fun iniview() {
      ...
      var  linearLayoutManager =
        ...
        requests_list!!.layoutManager = linearLayoutManager
    }
                ...
                if (response.body() != null) {
                    ...
                    if (response.isSuccessful){
                        ...
                        if (jsonObject.getString("success").toString().trim().equals("1")){
                            ...
                            var adapter = RequestListAdapter(productList, mActivity!!,false)
                            requests_list!!.adapter=adapter;
                        } else {
                            LocalModel.instance!!.cancelProgressDialog()
                        }
                    }
